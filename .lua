...
local rageTab = lib:Create("rage mode :O")
local rageToggle = lib:AddToggle("master switch",function(state)
	rage = state
end)
local AA = lib:AddList("anti aim",function(choice)
	antiAim = choice
...
local sellout2 = lib:Create("rent#8392 | i love sharkey and roblox")
local sellout3 = lib:Create("roblox is the best roblox")
